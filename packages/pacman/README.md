...
The current evaluation goal is to clear the first maze before losing all lives. The hosted game and its page structure are external dependencies; if they change, this bridge may need updating.
