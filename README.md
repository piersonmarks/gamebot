...
Gamebot is an early TypeScript runtime for comparing ways to play games with a strategist, tactician, fast reflex/JEV decisions, and executable skills. Local path, Chess, Snake, and a Pac-Man-style maze game are runnable in this workspace. The 2048 browser bridge plays the creator's live Classic website; other external-game bridges require their games to be installed and running separately.
